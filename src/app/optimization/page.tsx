  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-orbitron font-bold text-[#06B6D4] mb-4 uppercase tracking-widest">PC Optimization</h1>
        <p className="text-[#9CA3AF] mb-8 font-poppins">Boost your FPS, reduce latency, and maximize your hardware's gaming potential.</p>
        ...
        <div className="bg-[#0F172A]/80 backdrop-blur-md border border-white/10 rounded-2xl p-12 text-center shadow-[0_0_30px_rgba(6,182,212,0.1)]">
           ...
           <p className="text-[#9CA3AF] max-w-lg mx-auto leading-relaxed font-poppins">
             Our operatives are currently gathering fresh intelligence for this section. The network is establishing connections to bring you the best optimization guides soon. 
           </p>
