...
export const metadata: Metadata = {
  title: "Gaming News & Guides | GamesDealsHub",
  description: "Read the latest gaming hardware reviews, free game guides, and Epic Games Store predictions from the GamesDealsHub team."
};
...
export default function NewsIndex() {
  return (
    <div className="py-8 pt-24 animate-in fade-in max-w-7xl mx-auto px-4">
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        {articles.map(article => (
          <article key={article.id} className="bg-[#0F172A] border border-white/10 rounded-2xl overflow-hidden hover:border-[#06B6D4]/50 transition-colors group flex flex-col h-full">
            <Link href={article.slug} className="block relative h-48 overflow-hidden">
