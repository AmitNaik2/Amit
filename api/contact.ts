export default async function handler(req: any, res: any) {
  try {
    ...
    const title = "Contact Us | GamesDealsHub";
    const desc = "Get in touch with the GamesDealsHub team for support or feedback.";
    const canonical = "https://www.gamesdealshub.me/contact";
